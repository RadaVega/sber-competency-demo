...
const steps: Record<ModeId, Step[]> = {
  ...
  future2035: [
    ...
    { screenId: "initiative",   title: "Инициатива",
      narration: "Новое направление, выход на рынок, слияние культур — неважно, какая именно стратегическая задача. Логика поиска компетенций и сборки команды универсальна." },
    { screenId: "future",       title: "Будущее",

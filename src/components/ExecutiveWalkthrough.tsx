...
const steps: Record<ModeId, Step[]> = {
  ...
  rosatom: [
    ...
    { screenId: "why",           title: "Два взгляда",              narration: "Директор программы видит: не хватает специалистов по SMR и литиевым технологиям. Инженер видит: не понимаю, как здесь вырасти. Платформа выравнивает оба взгляда — конкретными парами «потребность программы ↔ цель специалиста»." },

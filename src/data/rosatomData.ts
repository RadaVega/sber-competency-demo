...
export const nationalCapabilities: NationalCapability[] = [
  { name: "Ледокольная навигация и логистика", project: "Северный морской путь", maturity: 71, risk: "low", gapSummary: "Требуется расширение экспертизы в автономной навигации." },
  { name: "Композитные материалы для экстремальных условий", project: "Композитные материалы", maturity: 54, risk: "medium", gapSummary: "Дефицит специалистов по высокотемпературным композитам." },
  { name: "Малые модульные реакторы", project: "Новые энергетические системы", maturity: 48, risk: "high", gapSummary: "Критический дефицит инженеров-проектировщиков SMR." },
  { name: "Извлечение и переработка лития", project: "Литиевые технологии", maturity: 33, risk: "high", gapSummary: "Технология в ранней стадии — почти нет внутренней экспертизы." },
  { name: "Промышленная робототехника", project: "Роботизация промышленности", maturity: 62, risk: "medium", gapSummary: "Нехватка специалистов по интеграции робототехники и AI." },
  { name: "Космическое приборостроение", project: "Космические проекты", maturity: 58, risk: "medium", gapSummary: "Требуется развитие компетенций в радиационно-стойкой электронике." },
];
...
export const heatMapDomains: HeatMapDomain[] = [
  { name: "Реакторные технологии", level: 10, risk: "low", explanation: "Базовая компетенция отрасли — глубокий внутренний опыт, риск минимален." },
  { name: "Цифровой инжиниринг", level: 7, risk: "medium", explanation: "Растущий спрос со стороны программ цифровых двойников опережает темп подготовки инженеров." },
  { name: "Материаловедение", level: 8, risk: "low", explanation: "Устойчивая экспертная база, но требует обновления под новые сплавы и композиты." },
  { name: "Системы безопасности", level: 9, risk: "low", explanation: "Критическая компетенция с непрерывным потоком подготовки специалистов." },
  { name: "AI для инженерии", level: 4, risk: "high", explanation: "Новое направление — практически нет внутренней экспертизы, специалисты нужны немедленно." },
];

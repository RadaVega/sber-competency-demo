...
export const knowledgeRiskEmployeeRecommendations = [
  { action: "Станьте учеником", detail: "У Олега Денисова (литиевая металлургия) почти нет преемников — учиться у него сейчас значит стать одним из немногих носителей технологии в стране." },
  { action: "Изучите методики SMR", detail: "Знания по проектированию SMR активно фиксируются в базе — сейчас лучший момент их освоить, пока ключевые эксперты ещё рядом." },
  { action: "Рассмотрите редкую нишу", detail: "Радиационно-стойкая электроника — всего 5 специалистов на всю программу. Редкая экспертиза заметнее массовой." },
  { action: "Направление с наивысшим спросом", detail: "Литиевые технологии — 84% риск потери знаний означает 84% шанс, что именно ваш вклад станет критически важным." },
];

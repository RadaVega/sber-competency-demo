...
export interface ModeConfig {
  ...
  missionRu: string;
  // The concrete first consulting engagement this scenario leads to —
  // sells a project, not a licence. Closes the scenario in FutureScreen.
  consultingPitchRu: string;
  accentColor: string;
  badgeLetter: string;
...
export const modes: Record<ModeId, ModeConfig> = {
  sber: {
    ...
    consultingPitchRu: "За три недели мы покажем реальные организационные ограничения, которые замедляют AI-трансформацию — не отчёт, а карту, с которой можно прийти на совет директоров.",
    accentColor: "#21A038",
    badgeLetter: "С",
  ...
  vk: {
    ...
    consultingPitchRu: "Мы найдём, почему две похожие команды выпускают продукты с разной скоростью — и покажем, где именно расходится темп, а не кто виноват.",
    accentColor: "#0077FF",
    badgeLetter: "VK",
  ...
  rosatom: {
    ...
    consultingPitchRu: "За две недели мы построим карту критической инженерной экспертизы по вашим стратегическим программам — кто единственный носитель знаний и кто должен стать его преемником уже сегодня.",
    accentColor: "#6BC4E8",
    badgeLetter: "Р",
  ...
  yandex: {
    ...
    consultingPitchRu: "Мы покажем, где компания сегодня повторяет уже сделанные исследования — и сколько месяцев работы можно вернуть, просто соединив то, что уже есть.",
    accentColor: "#FFCC00",
    badgeLetter: "Я",
  ...
  future2035: {
    ...
    consultingPitchRu: "За месяц мы определим пять инициатив в вашей организации, которые уже можно ускорить — без внедрения новой системы, просто увидев то, что сейчас не видно.",
    accentColor: "#C9B8FF",
    badgeLetter: "∞",

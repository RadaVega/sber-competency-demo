...
export const agentChain: AgentStep[] = [
  {
    ...
    nameEn: "Competency Analyzer",
    description: "Сопоставляет текущие навыки сотрудника с профилем роли.",
  },
  {
    id: "agent-2",
    name: "Анализ пробелов",
    nameEn: "Gap Analysis",
    description: "Определяет критические дефициты и их влияние на цель.",
  },
  {
    id: "agent-3",
    name: "Подбор наставника",
    nameEn: "Mentor Matching",
    description: "Находит экспертов, закрывающих выявленные пробелы.",
  },
  {
    id: "agent-4",
    name: "План развития",
    nameEn: "Learning Planner",
    description: "Строит дорожную карту развития на 30/60/90 дней.",
  },
  {
    id: "agent-5",
    name: "Формирование команды",
    nameEn: "Team Formation",
    description: "Собирает команду под стратегическую задачу.",
  },
  {
    id: "agent-6",
    name: "Рекомендация руководителю",
    nameEn: "Executive Recommendation",
    description: "Формирует executive summary для принятия решения.",
  },
];

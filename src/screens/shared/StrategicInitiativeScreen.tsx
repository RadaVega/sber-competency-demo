...
const initiativesByMode: Record<string, { title: string; subtitle: string; icon: string }[]> = {
  ...
  future2035: [
    { icon: "🧭", title: "Новое стратегическое направление",       subtitle: "Компетенций для него пока нет ни у кого" },
    { icon: "🌍", title: "Выход на новый рынок",                   subtitle: "Экспертиза нужна быстрее, чем можно нанять" },
    { icon: "🧬", title: "Технология, которой вчера не существовало", subtitle: "Организация должна вырастить её изнутри" },
    { icon: "🔗", title: "Слияние или трансформация бизнеса",      subtitle: "Две культуры компетенций должны стать одной" },
    { icon: "⏱", title: "Критический срок реализации стратегии",   subtitle: "Каждая неделя промедления имеет цену" },
  ],
};
